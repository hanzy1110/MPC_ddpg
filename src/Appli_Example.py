    ...
    def add_points(self):
        while self.is_running:
            ...
            try:
                ...
                current_state = np.array([self.last_output_velocity, 0, 0,0,0,0])  # Modify the state accordingly-self.mpc_controllerupp.controlup(current_state, self.last_output_dis_target)[1]*20
